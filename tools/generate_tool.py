...
class GenerateTool:
    SUPPORTED_TYPES = {"image", "video", "audio", "document", "svg", "chart", "pdf"}
    ...
    async def _generate_document(self, prompt: str, options: dict) -> dict:
        ...
        if doc_type == "pdf":
            ...
            try:
                ...
                pdf.cell(0, 20, title[:80], new_x="LMARGIN", new_y="NEXT", align="C")
                pdf.ln(10)
                ...
                for para in paragraphs:
                    ...
                    if para.startswith("#"):
                        ...
                        bullet_text = para[2:].strip()
                        pdf.cell(10, 7, chr(8226), new_x="END")
                ...
                pdf.cell(0, 8, f"Generated by Manus Agent | {time.strftime('%Y-%m-%d %H:%M:%S')}", align="C")
